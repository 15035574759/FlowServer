   var loadingBox = function(obj){
        ...
        "#loadBox .load-content{min-width:220px;height:60px;line-height:30px;padding:15px 20px;text-align:center;color:"+self.color+";background:rgb(49,41,35);border-radius: 12px;position: absolute;left:50%;top:50%;transform:translate(-50%,-50%)} " +
