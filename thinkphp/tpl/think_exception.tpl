...
<head>
    ...
    <style>
        ...
        fieldset{padding:0 15px 10px 15px;}
			#header h1{font-size:2.4em;margin:0;color:#FFF;}
			#content h2{font-size:1.7em;margin:0;color:#CC0000;}
			#content h3{font-size:1.2em;margin:10px 0 0 0;color:#000000;}
			#header{width:96%;margin:0 0 0 0;padding:6px 2% 6px 2%;font-family:"trebuchet MS", Verdana, sans-serif;color:#FFF;
			background-color:#555555;margin-top:-20px;}
    ...
    <div id="header"><h1>服务器错误</h1></div>
			<div id="content">
			 <div class="content-container"><fieldset>
			  <h2 style="font-weight:900;">500 - 内部服务器错误。</h2>
			  <h3>您查找的资源存在问题，已更改名称或者暂时不可用。</h3>
			 </fieldset></div>
		</div>
    <!-- <div class="copyright">
