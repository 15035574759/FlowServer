...
class User extends Base
{
    ...
    public function useradd()
    {
        if(request()->isAjax()){
            ...
            if($flag['code'] == -1) return json(['code' => $flag['code'], 'data' => $flag['data'], 'msg' => $flag['msg']]);
            $accdata = array(
                'uid'=> $user['id'],
        ...
        $ProjectData = $project->showAllProject();
    ...
    public function userEdit()
    {
        ...
        $project = new ProjectModel();
        $ProjectData = $project->showAllProject($data['project_start']);
        // p($ProjectData);
        $this->assign('ProjectData',$ProjectData);
        $this->assign([
            'user' => $data,
