...
class UserModel extends Model
{
    ...
    {
        return $this->field('flow_admin.*,title')->join('flow_auth_group', 'flow_admin.groupid = flow_auth_group.id')
    ...
    public function insertUser($param)
    {
        try{
            ...
            if(true == @DB::name($this->name)->where("username",$param['username'])->find()) {
              return ['code' => -1, 'data' => '', 'msg' => '用户已经存在'];
            }
